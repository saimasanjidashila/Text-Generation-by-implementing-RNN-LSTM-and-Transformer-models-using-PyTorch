...
def train_model():
    ...
    for epoch in range(EPOCHS):
        ...
        if avg_val_loss < best_val_loss:
          ...
          torch.save(model.state_dict(), "best_LSTMmodel.pt")
          print(" Model saved!")
          early_stop_counter = 0  
        else:
    ...
    model.load_state_dict(torch.load("best_LSTMmodel.pt"))
    # LOAD TEST DATASET
    ...
    if train_losses and val_losses:
      ...
      plt.grid(True)
      plt.tight_layout()
      plt.savefig("loss_LSTM_curve.png")
      plt.close()
      print("loss_LSTM_curve.png saved.")
    else:
